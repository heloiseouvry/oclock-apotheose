...
function TechModal ({tech, onDelete}) {
  ...
  const [prestaChecked, setPrestaChecked] = useState(false);
    ...
    return(
        ...
        <h1 className='title'>{tech ? "Modifier un technicien" : "Ajouter un technicien"}</h1>
            ...
            <Form onSubmit={handleSubmit}> 
              <Form.Group>
                ...
                <Form.Field required>
                  ...
                  <input id="phone_number" type='tel' value={addTechForm.phone_number} onChange={(event) => setAddTech({ ...addTechForm, phone_number: event.target.value })}/>               
                </Form.Field>
                <Form.Field required>
              ...
              <Form.Group>
                ...
                <Form.Field required>
                  ...
                  <input id="birth_department" type='number' value={addTechForm.birth_department} onChange={(event) => setAddTech({ ...addTechForm, birth_department: event.target.value })}/>               
                </Form.Field>
              </Form.Group>
              <Form.Group>
                ...
                <Form.Field required>
                  <label htmlFor="emergency_phone_number">N° de téléphone du contact d'urgence</label>
                  <input id="emergency_phone_number" type='tel' value={addTechForm.emergency_phone_number} onChange={(event) => setAddTech({ ...addTechForm, emergency_phone_number: event.target.value })}/>               
                </Form.Field>
              ...
              <Form.Group>
                ...
                <Form.Field name='intermittent'>
                  <label htmlFor="intermittent_registration">N° de Congés Spectacles</label>
              ...
              <Form.Group inline>
                <div>Métier</div>
                <Form.Field>
                  <Checkbox label='Son' value='1' onChange={(_, data)=>setAddJob({...addJob, [data.value]: data.checked})} />
                  <Checkbox label='Lumière' value='2' onChange={(_, data)=>setAddJob({...addJob, [data.value]: data.checked})} />
                  <Checkbox label='Vidéo' value='3' onChange={(_, data)=>setAddJob({...addJob, [data.value]: data.checked})} />
                  <Checkbox label='Autre' value='4' onChange={(_, data)=>setAddJob({...addJob, [data.value]: data.checked})} />
                </Form.Field>
              </Form.Group>
              <Form.Group >
                <Form.Field>
